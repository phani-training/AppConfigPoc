...
namespace AppConfigLambda
{
    public class Function
    {
        private static readonly string AppConfigApplicationId = "drmyok5";  // Replace with your AppConfig Application Id
        private static readonly string AppConfigEnvironmentId = "nq82t4j";            // Replace with your AppConfig Environment Id
        private static readonly string AppConfigConfigurationProfileId = "fass4wi"; // Replace with your Configuration Profile Id
        private static readonly string AppConfigClientToken = "client-token";                     // Replace with a unique client token
